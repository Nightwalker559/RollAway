...
L["qol_join_reminder_info"]   = "Displays the instance name when you join a dungeon or raid group. The reminder stays visible until the group is full, then disappears after 6 seconds."
L["qol_join_keyaddon_label"]  = "Open keystone companion addon with reminder:"
L["qol_join_keyaddon_info"]      = "Opens the selected teleport helper when you join a Mythic+ group or create your own. Raids always use the default reminder above."
...
L["qol_premade_keyaddon_info"]   = "Separate choice for premade Mythic+ groups (direct invites, not via Group Finder): the RollAway Teleport Reminder can't resolve the exact dungeon here, so pick BigWigs or Details! instead."
...
L["qol_log_enable_info"]        = "Flips /combatlog on and off as you enter or leave matching content. The file lands at Logs\\WoWCombatLog.txt in your WoW folder — upload it to a site like warcraftlogs.com, then delete it so it doesn't keep growing."
