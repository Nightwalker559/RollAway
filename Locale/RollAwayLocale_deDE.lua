...
L["qol_join_reminder_info"]   = "Zeigt den Instanznamen an, wenn du einer Dungeon- oder Raid-Gruppe beitrittst. Der Hinweis bleibt sichtbar bis die Gruppe voll ist, und verschwindet danach nach 6 Sekunden."
L["qol_join_keyaddon_label"]  = "Begleit-Addon für Schlüsselsteine mit Hinweis öffnen:"
L["qol_join_keyaddon_info"]      = "Öffnet die gewählte Teleport-Hilfe, wenn du einer Mythisch-Plus-Gruppe beitrittst oder selbst eine erstellst. Raids nutzen immer den Standard-Hinweis oben."
...
L["qol_premade_keyaddon_info"]   = "Eigene Auswahl für Premade-Mythisch-Plus-Gruppen (direkte Einladungen, nicht über die Gruppensuche): der RollAway Teleport-Hinweis kann hier den genauen Dungeon nicht ermitteln, daher stattdessen BigWigs oder Details! wählen."
...
L["qol_log_enable_info"]        = "Schaltet /combatlog beim Betreten/Verlassen passender Inhalte automatisch um. Datei liegt danach unter Logs\\WoWCombatLog.txt in deinem WoW-Ordner, hochladbar auf Seiten wie warcraftlogs.com – nach dem Hochladen ruhig löschen, sonst wächst sie mit der Zeit."
